...
\section{Education}
{\color{DescriptionGray}
\textbf{Shenzhen MSU-BIT University}\\[0.2em]
% 前一行占满整个左栏宽度，只有末行给年份让位；用 tabular 固定列宽的话
% 每一行都会被压窄，学位名会被挤成三行
B.Eng. in Electronic and Computer\\
\makebox[\dimexpr\linewidth-0.5em\relax][l]{Engineering\hfill 2024 -- 2028}
}

\vspace*{0.5em}
\subSection{University Honors}
{\color{DescriptionGray}
First-Class Scholarship\\[0.2em]
Outstanding Student\\[0.2em]
Excellence in Sci-Tech Innovation
}
...
\section{Interests}
{\color{DescriptionGray}
Theoretical Computer Science\\[0.2em]
Algorithm Design and Analysis\\[0.2em]
...
\section{Hobbies}
{\color{DescriptionGray}
Piano, Violin, Drums (CMA Grade 10, Distinction), Badminton (Intramural Quarterfinalist), Debate (Intramural 2nd \& Best Debater)
}
...
\jobEntry{Research Assistant @ CUHK-Shenzhen}{Nov.\ 2025 -- Present}{Frontier research on algorithm analysis, data structures, graph theory and graph mining with Prof.\ Jingbang Chen, The Chinese University of Hong Kong, Shenzhen.}

\subSection{Industry}
\jobEntry{Algorithm Researcher @ RobustMotion}{May 2025 -- May 2026}{Authored an internal technical report; proposed the ``Turning-Potential Avoidance'' method for a class of data scheduling problems on planar grid graphs.}

\subSection{Competitive Programming}
\jobEntry{Lecturer @ NOI 2026 Hunan Provincial Team Training}{Apr.\ 2026}{}
\jobEntry{Lecturer @ Xuejun Xinyou Team Summer Camp}{Jul.\ -- Aug.\ 2026}{}
