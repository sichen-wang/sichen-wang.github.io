...
\textbf{Sichen Wang}, Zhipeng Lu.\ \textit{On Completion Times Under Memoryless Catastrophe}.\ Submitted to Stochastic Processes and their Applications.

\textbf{Sichen Wang}, Zhipeng Lu.\ \textit{Certified Reduction for Exact Bilinear Reachability}.\ Submitted to OOPSLA 2026.

Zhipeng Lu, \textbf{Sichen Wang}$^{*}$.\ \textit{Polynomial Partitioning for Sparse Matrices}.\ Submitted to ICPP 2026.\ {\small\color{DescriptionGray}($^{*}$ Co-first authors.)}
